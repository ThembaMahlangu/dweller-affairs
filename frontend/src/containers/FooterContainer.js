  ...
  return (
    <Footer>
      <Footer.Container>
        <Footer.Content>
          <Footer.Item>
            <Footer.Title>Dweller Affairs</Footer.Title>
            <Footer.Text>
              23 Error St, New Doornfontein, Johannesburg, South Africa
            </Footer.Text>
            <Footer.List>
              <Footer.ListItem>
                <Footer.Icon name="fas fa-phone-alt" social="true" />
                <Footer.Text>+27769360246</Footer.Text>
              </Footer.ListItem>
              <Footer.ListItem>
      ...
      <Footer.Bottom>
        <Footer.Container>
          <Footer.Text>&copy; Dweller Affairs. All Rights Reserved 2022</Footer.Text>
        </Footer.Container>
      </Footer.Bottom>
    </Footer>
  );
